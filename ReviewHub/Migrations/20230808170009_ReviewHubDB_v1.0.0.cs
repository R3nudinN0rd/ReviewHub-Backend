...
{
    /// <inheritdoc />
    public partial class ReviewHubDB_v100 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Str. Doctor Stefan Odobleja, Nr. 2 Bl. C6, Sc.D", "", "Pitesti", "Romania", "Arges", new DateTime(2023, 8, 8, 20, 0, 8, 909, DateTimeKind.Local).AddTicks(1298), new DateTime(1999, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 16000, "remusene69@gmail.com", "Remus", new byte[] { 32, 32, 32, 32, 32, 32, 32 }, "Ene", "Lexy2806!", 6, 1, "R3nudinN0rd", true },
                    { 2, "Str. Doctor Stefan Odobleja, Nr. 2 Bl. C7, Sc.A", "", "Pitesti", "Romania", "Arges", new DateTime(2023, 8, 8, 20, 0, 8, 909, DateTimeKind.Local).AddTicks(1324), new DateTime(1999, 11, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 8000, "voiculescumadalin@gmail.com", "Madalin", new byte[] { 32, 32, 32, 32, 32, 32, 32 }, "Voiculescu", "ParolaMea1234!", 5, 3, "PigeonusMaximus", true },
                    { 3, "Str. Principala, Nr1", "", "Babana", "Romania", "Arges", new DateTime(2023, 8, 8, 20, 0, 8, 909, DateTimeKind.Local).AddTicks(1332), new DateTime(1999, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 4000, "nicolsescurober42@gmail.com", "Robert", new byte[] { 32, 32, 32, 32, 32, 32, 32 }, "Nicolescu", "ParolaMea5678!", 4, 2, "R0b1", true }
                });
